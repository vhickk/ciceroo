...
// Psychology: any Social/Arts/Science, but UNILAG does NOT accept Commerce, CRS/IRS, Financial Accounting.
export const PSYCH_POOL = uniq([...ARTS_SUBS, ...SOCIAL_SUBS, ...SCIENCE_SUBS].filter((s) => !["Commerce","Christian Religious Studies","Islamic Religious Studies","Financial Accounting"].includes(s)));
...
export const PROGRAMMES: Programme[] = [
  ...
  {name:"Employment Relations & HRM", faculty:"Faculty of Management Sciences", merit:60.775, catchment:{Ekiti:55.65,Lagos:59.6,Ogun:54.5,Ondo:60.025,Osun:58.15,Oyo:53.925},
   ...
   requirements:[
    ...
    {label:"Mathematics",subjects:["Mathematics"],count:1},
    {label:"Economics",subjects:["Economics"],count:1},
    {label:"2 electives",subjects:["Financial Accounting","Geography","Government","Data Processing","Biology","Business Management","Social Studies"],count:2},
   ]},
  {name:"Procurement Management", faculty:"Faculty of Management Sciences", merit:67.175, catchment:{Ekiti:58.7,Lagos:58.625,Ogun:65.675,Ondo:64.75,Osun:60.95,Oyo:64.35},
   utme:["English Language","Mathematics","Economics","+1 elective"],
   utmeReqs:[{subjects:["English Language"],count:1},{subjects:["Mathematics"],count:1},{subjects:["Economics"],count:1},{subjects:["Business Management","Government","Chemistry","Physics"],count:1}],
   requirements:[
    {label:"English Language",subjects:["English Language"],count:1},
    {label:"Mathematics",subjects:["Mathematics"],count:1},
    {label:"3 electives",subjects:["Economics","Physics","Chemistry","Financial Accounting","Government","Civic Education","Geography"],count:3},
   ]},
  ...
  {name:"Igbo", faculty:"Faculty of Arts", merit:0, catchment:{},
   utme:["English Language","+3 Arts/Science/Social"],
   utmeReqs:[{subjects:["English Language"],count:1},{subjects:ARTS_SCIENCE_SOCIAL,count:3,label:"Arts / Science / Social Sciences"}],
   requirements:[
    {label:"English Language",subjects:["English Language"],count:1},
  ...
  {name:"Public Administration", faculty:"Faculty of Social Sciences", merit:74.2, catchment:{Ekiti:63.025,Lagos:68.475,Ogun:73.475,Ondo:69.625,Osun:70.25,Oyo:72.05},
   ...
   requirements:[
    {label:"English Language",subjects:["English Language"],count:1},
    {label:"Mathematics",subjects:["Mathematics"],count:1},
    {label:"Government / Civic Education / History",subjects:["Government","Civic Education","History"],count:1},
    {label:"Economics",subjects:["Economics"],count:1},
  ...
  {name:"Library & Information Science", faculty:"Faculty of Social Sciences", merit:66.625, catchment:{Lagos:62.95,Ogun:63.3,Ondo:61.225,Osun:60.85,Oyo:66.55},
   ...
   requirements:[
    {label:"English Language",subjects:["English Language"],count:1},
    {label:"Mathematics",subjects:["Mathematics"],count:1},
    {label:"3 of Arts/Science/Social Sciences",subjects:uniq(["Government","Economics","Data Processing","History","Literature-in-English","Christian Religious Studies","Islamic Religious Studies","Physics","Chemistry","Biology","French",...NIG_LANG]),count:3},
   ]},
  {name:"Economics & Development Studies", faculty:"Faculty of Social Sciences", merit:65.725, catchment:{Lagos:59.8,Ogun:62.425,Ondo:58.175,Oyo:61.8},
   utme:["English Language","Mathematics","Economics","+1 subject"],
   utmeReqs:[{subjects:["English Language"],count:1},{subjects:["Mathematics"],count:1},{subjects:["Economics"],count:1},{subjects:["__ANY__"],count:1}],
   requirements:[
    {label:"English Language",subjects:["English Language"],count:1},
